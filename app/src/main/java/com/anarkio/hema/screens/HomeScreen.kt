...
fun HomeScreenContent(
    ...
    Column(
        ...
        Row(
            ...
            HemaLabel(text = stringResource(id = R.string.home_screen_greeting))
            Image(
                modifier = Modifier.size(50.dp),
                contentDescription = stringResource(id = R.string.hema_icon_cd),
                painter = painterResource(id = R.drawable.hema_icon),
            )
        }
